...
Dropzone.autoDiscover = false;
	...
	$(document).ready(function(){
			...
			$("#submit-all").click(function (e) {
		       e.preventDefault();
		       e.stopPropagation();
		       myDropzone.options.url="../API/controlador/agregarLocalFotos.php?idPerfil=19";
		       myDropzone.processQueue();
		    });
...
<body>
    <form action="../API/controlador/agregarLocalFotos.php?idPerfil=19" id="fotos" class="dropzone" enctype="multipart/form-data">
    </form>
